...
<section class="container mx-auto p-6 bg-white">
    ...
    <div class="flex gap-4">
        <a href="{{route('payments.edit', $payment->id)}}" class="flex"><i data-feather="edit"></i><span class="ml-2">Editar</span> </a>
        <form method="POST" action={{route('payments.delete', $payment->id)}} onsubmit="return confirm('Você tem certeza que quer deletar o boleto?')">
            @csrf
            @method('DELETE')
